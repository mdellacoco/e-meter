...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/e-meter: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/e-meter ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/_ext/64c5b032/ReadStreamPopulateDB.o: ../eMeterLib/ReadStreamPopulateDB.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/64c5b032
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/64c5b032/ReadStreamPopulateDB.o ../eMeterLib/ReadStreamPopulateDB.cpp
...
${OBJECTDIR}/WatchDir.o: WatchDir.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/WatchDir.o WatchDir.cpp
